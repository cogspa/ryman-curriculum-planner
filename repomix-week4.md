...
- Only files matching these patterns are included: src/pages/Week04Overview.jsx, src/pages/Week04TopicDetail.jsx, src/content/week04Topics.js
  ...
  return (
    <div style={containerStyle}>
      ...
      <header style={headerStyle}>
        <div style={weekTagStyle}>WEEK 04</div>
        <div style={dateRangeStyle}>JUL 14 – JUL 18</div>
      </header>
      ...
      <p style={focusStyle}>
        <strong>Focus:</strong> Designing for digital platforms
      </p>
      ...
      <ul style={topicListStyle}>
        {topicList.map(({ key, label, isNew }) => (
          <li key={key} style={topicItemStyle}>
            ...
            <Link to={`/week/04/${key}`} style={topicLinkStyle}>
              {label}
            </Link>
          </li>
        ))}
      ...
      <ul style={topicListStyle}>
        {readingsList.map(({ key, label, isNew }) => (
          <li key={key} style={topicItemStyle}>
            {isNew && <span style={newBadgeStyle}>NEW</span>}
            <Link to={`/week/04/${key}`} style={topicLinkStyle}>
              {label}
