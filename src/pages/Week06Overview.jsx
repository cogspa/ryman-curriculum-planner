...
export default function Week06Overview() {
  return (
    <div style={containerStyle}>
      ...
      <header style={headerStyle}>
        <div style={weekTagStyle}>WEEK 06</div>
        <div style={dateRangeStyle}>JUL 28 – AUG 01</div>
      </header>

      <h1 style={titleStyle}>Introduction to Commercial Application</h1>

      <div style={scheduleStyle}>
        <div><strong>TUE</strong> &nbsp; Tue, Jul 28 &nbsp; · &nbsp; 7:00–8:30 pm · Zoom</div>
        <div><strong>SAT</strong> &nbsp; Sat, Aug 01 &nbsp; · &nbsp; 10:00 am–3:30 pm · Reveal Studio</div>
      </div>

      <p style={focusStyle}>
        <strong>Focus:</strong> Turning painterly skill into paid work
      </p>
      ...
      <ul style={topicListStyle}>
        {topicList.map(({ key, label, isNew }) => (
          <li key={key} style={topicItemStyle}>
            ...
            <Link to={`/week/06/${key}`} style={topicLinkStyle}>
              {label}
            </Link>
          </li>
        ))}
