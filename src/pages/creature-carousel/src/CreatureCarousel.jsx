 ...
 *
 * props
 *  items         [{ src, alt }]  artwork, transparent PNG/WebP recommended
 *  height        number          artwork height in px (card sizes itself from aspect)
 *  speed         number          pixels per second — constant regardless of item count
 *  gap           number          px between cards
 *  direction     "left" | "right"
 *  pauseOnHover  boolean
 *  label         string          eyebrow text shown above the strip
 */
