...
const speakersData = [
  ...
  },
  {
    ...
    org: 'LBE Concepts',
    industry: 'Location-Based Entertainment (LBE)',
    fit: 'Introduction to Commercial Application / Illustration, Character Dev & Visual Storytelling',
    contactPerson: 'Eugenia',
    contactDate: '',
    note: '',
    website: ''
  },
  {
    ...
    org: 'Walt Disney Imagineering (WDI)',
    industry: 'Location-Based Entertainment (LBE)',
    fit: 'Illustration, Character Dev & Visual Storytelling / Client Simulation Project Advisor',
  ...
  },
  {
    ...
    fit: 'Illustration, Character Dev & Visual Storytelling / Page layouts & Book Arts',
    contactPerson: 'Eugenia',
    contactDate: '',
    note: '',
    website: ''
